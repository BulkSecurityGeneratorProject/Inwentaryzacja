...
import { PlaceDialogComponent } from '../../../../../../main/webapp/app/entities/place/place-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Place Management Dialog Component', () => {
        let comp: PlaceDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(PlaceDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'placeListModification', content: 'OK'});
