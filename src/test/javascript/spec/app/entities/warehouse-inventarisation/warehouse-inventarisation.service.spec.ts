...
describe('Service Tests', () => {
    ...
    describe('WarehouseInventarisation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(WarehouseInventarisationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/warehouse-inventarisations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WarehouseInventarisation', () => {
